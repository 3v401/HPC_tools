...
7. [HPC Crawler]() TO DO: Create a tool that from a input.txt looks for all the extensions named 'word_row_i' to check if they are in the repo as dependency or module
